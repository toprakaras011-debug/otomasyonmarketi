...
-- Admin kontrolü için SECURITY DEFINER function kullanıyor
-- ============================================
...
-- ============================================
-- SECURITY DEFINER ile RLS bypass edilir, sonsuz döngü yok
...
-- ============================================
-- Helper function kullanıyoruz, user_profiles tablosunu direkt sorgulamıyoruz
...
USING (
  ...
  auth.uid() = id
  OR
  -- Admin ise tüm profilleri görebilir (helper function ile, sonsuz döngü yok)
...
USING (
  ...
  auth.uid() = id
  OR
  -- Admin ise tüm profilleri güncelleyebilir (helper function ile, sonsuz döngü yok)
  is_admin_user(auth.uid())
)
WITH CHECK (
  -- Kullanıcı kendi profilini güncelleyebilir
